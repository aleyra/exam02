...
int main()
{
	...
	ft_printf(""); ft_printf("\n");
	ft_printf("--Format---"); ft_printf("\n");
	ft_printf("\n"); ft_printf("\n");
	ft_printf("%d", 0); ft_printf("\n");
	ft_printf("%d", 42); ft_printf("\n");
	ft_printf("%d", 1); ft_printf("\n");
	ft_printf("%d", 5454); ft_printf("\n");
	ft_printf("%d", (int)2147483647); ft_printf("\n");
	ft_printf("%d", (int)2147483648); ft_printf("\n");
	ft_printf("%d", (int)-2147483648); ft_printf("\n");
	ft_printf("%d", (int)-2147483649); ft_printf("\n");
	ft_printf("\n"); ft_printf("\n");
	ft_printf("%x", 0); ft_printf("\n");
	ft_printf("%x", 42); ft_printf("\n");
	ft_printf("%x", 1); ft_printf("\n");
	ft_printf("%x", 5454); ft_printf("\n");
	ft_printf("%x", (int)2147483647); ft_printf("\n");
	ft_printf("%x", (int)2147483648); ft_printf("\n");
	ft_printf("%x", (int)-2147483648); ft_printf("\n");
	ft_printf("%x", (int)-2147483649); ft_printf("\n");
	ft_printf("%s", ""); ft_printf("\n");
	ft_printf("%s", "toto"); ft_printf("\n");
	ft_printf("%s", "wiurwuyrhwrywuier"); ft_printf("\n");
	ft_printf("%s", NULL); ft_printf("\n");
	ft_printf("-%s-%s-%s-%s-\n", "", "toto", "wiurwuyrhwrywuier", NULL); ft_printf("\n");
	ft_printf("\n--Mixed---\n"); ft_printf("\n");
	ft_printf("%d%x%d%x%d%x%d%x\n", 0, 0, 42, 42, 2147483647, 2147483647, (int)-2147483648, (int)-2147483648); ft_printf("\n");
	ft_printf("-%d-%x-%d-%x-%d-%x-%d-%x-\n", 0, 0, 42, 42, 2147483647, 2147483647, (int)-2147483648, (int)-2147483648); ft_printf("\n");
	ft_printf("\n"); ft_printf("\n");
	ft_printf("%s%s%s%s\n", "", "toto", "wiurwuyrhwrywuier", NULL); ft_printf("\n");
	ft_printf("-%s-%s-%s-%s-\n", "", "toto", "wiurwuyrhwrywuier", NULL); ft_printf("\n");
	ft_printf("--1 Flag--\n"); ft_printf("\n");
	ft_printf("d0w %0d %0d %0d %0d %0d %0d %0d %0d\n", 0, 42, 1, 4554, 2147483647, (int)2147483648, (int)-2147483648, (int)-2147483649); ft_printf("\n");
	...
	ft_printf("s0p ~%.0s` ~%.0s` ~%.0s` ~%.0s` ~%.0s`\n", "", "toto", "0123456789", "tjehurthteutuiehteute", NULL); ft_printf("\n");
	...
	ft_printf("d10w10p %10.10d %10.10d %10.10d %10.10d %10.10d %10.10d %10.10d %10.10d\n", 0, 1, 42, 4554, 2147483647, (int)2147483648, (int)-2147483648, (int)-2147483649); ft_printf("\n");
